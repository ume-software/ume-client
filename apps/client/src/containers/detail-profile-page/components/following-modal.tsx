...
const FollowingModal = ({ isFollowingModalVisible, setIsFollowingModalVisible }) => {
  ...
  const [follwingData, setFollwingData] = useState<UserInformationPagingResponse['row']>(undefined)
  ...
  } = trpc.useQuery(['booking.getFollowingByUserSlug', { slug: String(slug.profileId ?? ''), page: page }], {
