...
const MoreTable = (props) => {
    ...
    return (
        <>
            {props.children ?
                (props.children.icon ? (<div className='w-full overflow-hidden hover:bg-gray-700 group rounded-md pl-2 pr-2 '>
                    ...
                    : (<a href='#' className='hover:bg-gray-700 rounded-md pl-2 pr-2'>{props.children.name}</a>))
