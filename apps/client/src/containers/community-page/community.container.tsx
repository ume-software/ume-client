      ...
      <div className="min-h-screen" style={{ margin: '0 70px' }}>
        <div className="grid grid-cols-10 gap-10 text-white">
          <div className="xl:col-span-2 col-span-6 relative">
            <div className="flex xl:flex-col xl:items-start items-center gap-10 xl:border-none border-b-2 border-white border-opacity-30 xl:sticky fixed xl:top-20 top-16 left-0 right-20 z-[5]">
