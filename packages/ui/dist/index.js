      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs('span', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx('span', {
              className:
                'absolute flex items-center justify-center w-10 h-full pointer-events-none peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent text-slate-400',
              children: icon,
            }),
          ],
        }),
        subtitle &&
          /* @__PURE__ */ jsxRuntime.jsx('div', {
            className: 'mt-1.5 text-slate-400 text-[.6875rem]',
            children: subtitle,
          }),
        error &&
          /* @__PURE__ */ jsxRuntime.jsx('span', {
            className: 'mt-1.5 inline-block text-ume-error text-[14px]',
            children: error,
          }),
      ],
    }),
